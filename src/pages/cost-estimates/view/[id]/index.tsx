...
import { getCostEstimateById } from 'apiSdk/cost-estimates';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Cost Estimate Detail View
          </Text>
          {hasAccess('cost_estimate', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/cost-estimates/edit/${data?.id}`} passHref legacyBehavior>
              <Button
